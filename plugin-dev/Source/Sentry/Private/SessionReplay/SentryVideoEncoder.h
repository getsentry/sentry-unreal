 ...
 */
class FSentryVideoEncoder : public ISentryVideoEncoder, public FRunnable
{
public:
	...
	// The hardware encoder consumes the GPU resource directly
	virtual bool RequiresCpuReadableFrames() const override { return false; }
