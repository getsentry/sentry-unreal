...
FSentryFMP4FragmentBuilder::FSentryFMP4FragmentBuilder(FSentrySessionReplayRecorder& InRecorder)
	: Recorder(InRecorder)
{
}

void FSentryFMP4FragmentBuilder::SetDimensions(uint32 InWidth, uint32 InHeight)
{
	Width = InWidth;
	Height = InHeight;
}

void FSentryFMP4FragmentBuilder::AddAccessUnit(const uint8* AnnexB, int64 Size, bool bKeyframe, uint32 DurationTicks)
{
...
void FSentryFMP4FragmentBuilder::Flush()
{
...
void FSentryFMP4FragmentBuilder::Reset()
{
	CurrentSamples.Reset();
