...
#include "MicrosoftSentryHint.h"

#include "GenericPlatform/GenericPlatformSentryAttachment.h"

#if USE_SENTRY_NATIVE

void FMicrosoftSentryHint::AddFileAttachment(TSharedPtr<FGenericPlatformSentryAttachment> attachment)
{
...
void FMicrosoftSentryHint::AddByteAttachment(TSharedPtr<FGenericPlatformSentryAttachment> attachment)
{
