...
USentrySettings::USentrySettings(const FObjectInitializer& ObjectInitializer)
	...
	, EnableHangTracking(false)
	, HangTimeoutDuration(5.0f)
	, EnableCrashVideo(false)
	, CrashVideoWindowSeconds(12.0f)
	, CrashVideoFragmentSeconds(0.5f)
	, CrashVideoRotationIntervalSeconds(1.0f)
	, CrashVideoResolution(ESentryCrashVideoResolution::HD720)
	, CrashVideoFramerate(30)
	, CrashVideoBitrateKbps(2000)
	...
	, AndroidCrashBackend(ESentryAndroidCrashBackend::TombstoneMergedWithNdk)
	, EnableTracing(false)
