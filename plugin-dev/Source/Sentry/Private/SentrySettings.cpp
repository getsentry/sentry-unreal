...
USentrySettings::USentrySettings(const FObjectInitializer& ObjectInitializer)
	...
	, SessionReplayWindowSeconds(12.0f)
	, SessionReplayFragmentSeconds(0.5f)
	, SessionReplayRotationIntervalSeconds(1.0f)
	, SessionReplayFramerate(30)
	, SessionReplayBitrateKbps(2000)
