...
- Bump Cocoa SDK (iOS) from v8.27.0 to v8.28.0 ([#571](https://github.com/getsentry/sentry-unreal/pull/571))
...
- Bump Java SDK (Android) from v7.9.0 to v7.10.0 ([#572](https://github.com/getsentry/sentry-unreal/pull/572))
