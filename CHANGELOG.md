...
- Bump Native SDK from v0.6.3 to v0.6.4 ([#313](https://github.com/getsentry/sentry-unreal/pull/313))
...
- Bump Java SDK (Android) from v6.24.0 to v6.25.0 ([#316](https://github.com/getsentry/sentry-unreal/pull/316))
