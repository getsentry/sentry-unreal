...
- Bump Java SDK (Android) from v7.10.0 to v7.11.0 ([#588](https://github.com/getsentry/sentry-unreal/pull/588))
...
- Bump Java SDK (Android) from v7.11.0 to v7.12.0 ([#599](https://github.com/getsentry/sentry-unreal/pull/599))
