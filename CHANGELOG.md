...
- Bump Java SDK (Android) from v6.34.0 to v7.0.0 ([#460](https://github.com/getsentry/sentry-unreal/pull/460))
...
- Bump Cocoa SDK (iOS) from v8.17.0 to v8.17.1 ([#461](https://github.com/getsentry/sentry-unreal/pull/461))
