...
- Bump Cocoa SDK (iOS) from v8.35.0 to v8.35.1 ([#620](https://github.com/getsentry/sentry-unreal/pull/620))
...
- Bump Cocoa SDK (iOS) from v8.35.1 to v8.36.0 ([#622](https://github.com/getsentry/sentry-unreal/pull/622))
