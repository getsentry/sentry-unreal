...
>
> This feature is experimental and off by default. To opt-in, enable `Attach session replay` in plugin settings. See the [Unreal SDK Session Replay documentation](https://docs.sentry.io/platforms/unreal/session-replay/) for additional details and setup instructions.
